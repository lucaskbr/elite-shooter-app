...
import { Button, GunCard, IsLoading, ProfilePic, Separator, Title, Username } from '../../components';
  ...
  return (
    <IsLoading condition={isLoading}>
      <View style={{
        ...
        <Button text="Ver mais" type="invisible" onPress={() => setIsModalVisible(true)} />
              ...
              ListFooterComponent={
                <View
                  style={{
                    ...
                    <Button text="Adicionar mais" onPress={() => navigate('AddGun')} />
                </View>
              }
              data={myGuns}
